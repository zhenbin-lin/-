...
public final class MeasureHelper {
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mCurrentAspectRatio == IRenderView.AR_MATCH_PARENT) {
            ...
            //AT_MOST 对应 NOT_EXCEED
            if (widthSpecMode == Component.MeasureSpec.NOT_EXCEED && heightSpecMode == Component.MeasureSpec.NOT_EXCEED) {
                ...
                //EXACTLY 对应 PRECISE
            } else if (widthSpecMode == Component.MeasureSpec.PRECISE && heightSpecMode == Component.MeasureSpec.PRECISE) {
                // the size is fixed
                width = widthSpecSize;
                height = heightSpecSize;
