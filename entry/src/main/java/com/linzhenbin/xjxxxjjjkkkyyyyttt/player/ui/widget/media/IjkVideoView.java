...
import com.linzhenbin.xjxxxjjjkkkyyyyttt.player.ui.Settings;
import com.linzhenbin.xjxxxjjjkkkyyyyttt.player.ui.adapter.InfoHudViewHolder;
...
import tv.danmaku.ijk.resource.Resource;
import tv.danmaku.ijk.utils.LogUtil;
...
//        addView(subtitleDisplay, layoutParams_txt);
    ...
    public void setRenderView(IRenderView renderView) {
        ...
        renderUIView.setLayoutConfig(new LayoutConfig(ComponentContainer.LayoutConfig.MATCH_PARENT,
...
//                setRenderView(renderView);
    ...
    public List<SampleItem> getHudViewDataLists() {
        if (mHudViewHolder != null) {
            List<SampleItem> dataLists = mHudViewHolder.getDataLists();
            return dataLists;
        }
        return null;
    }
...
//            if (mSettings.getUsingMediaDataSource() &&
...
//            else
            if (MediaConstant.OHOS_RESOURCE_SCHEME_RAW.equals(scheme)) {
                //String resourcepath="resources/base/media/video.mp4";
                String resourcepath = new Resource(mUri.toString()).getResourcePath();
                try {
                    mMediaPlayer.setDataSource(getResourceManager().getRawFileEntry(resourcepath).openRawFileDescriptor().getFileDescriptor());
                } catch (Exception e) {
                    LogUtil.e("nativeijk", "setDateSouce fail : " + e.getMessage());
                    return;
                }
            } else {
            ...
            LogUtil.e("ndk", "设置为当前状态" + mCurrentState);
    ...
    private IMediaPlayer.OnErrorListener mErrorListener =
            new IMediaPlayer.OnErrorListener() {
                public boolean onError(IMediaPlayer mp, int framework_err, int impl_err) {
                    LogUtil.w(getClass().getSimpleName() + " mErrorListener Error: " + framework_err + "," + impl_err);
                    mCurrentState = STATE_ERROR;
                    mTargetState = STATE_ERROR;
                    if (mMediaController != null) {
                        mMediaController.hide();
...
//                    }
    ...
    private IMediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener =
            new IMediaPlayer.OnBufferingUpdateListener() {
                public void onBufferingUpdate(IMediaPlayer mp, int percent) {
                    LogUtil.i(getClass().getSimpleName() + " onBufferingUpdate " + percent);
    ...
    private IMediaPlayer.OnSeekCompleteListener mSeekCompleteListener = new IMediaPlayer.OnSeekCompleteListener() {
        ...
        public void onSeekComplete(IMediaPlayer mp) {
            LogUtil.i(getClass().getSimpleName() + " onSeekComplete");
        ...
        switch (playerType) {
            ...
            default: {
                ...
                if (mUri != null) {
                    ...
                    //TODO 默认关闭native日志，打开方法:IjkMediaPlayer.IJK_LOG_DEBUG
...
//                    } else {
                    ...
                    //}
                    //TODO 设置缓冲大小、帧，解决播放卡顿问题
                    //设置缓冲区大小
                    ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "max-buffer-size", 8 * 1024);
                    //设置帧
